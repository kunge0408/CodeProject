...
GUIDEMO_SliderColor,
GUIDEMO_AA_Hirespixels,
GUIDEMO_DialogCount,

GUIDEMO_BandingMemdev,
GUIDEMO_VmVideo,
...
#if GUIDEMO_LARGE
	hProg = (t > 100) ? PROGBAR_CreateAsChild(10,
											  10,
											  60,
											  7,
											  _ahInfoWin[1],
...
void GUIDEMO_ShowIntro(const char *s, const char *sExp)
{
	...
	if (_sExplain)
	{
		GUI_SetFont(&GUI_Font8_ASCII);
#if !(GUIDEMO_TINY)
		GUI_DispStringHCenterAt(_sExplain,
								LCD_GET_XSIZE() / 2,
								LCD_GET_YSIZE() / 2 - 10);
#else
		GUI_DispStringHCenterAt(_sExplain,
...
void GUIDEMO_main(void)
{
 ...
 GUI_CONTEXT ContextOld;
  ...
  _iTestMinor=0;
...
#if GUI_WINSUPPORT
#if GUI_NUM_LAYERS > 1
	_ahFrameWin[2] = FRAMEWIN_CreateAsChild(10,
											10,
											100,
											100,
											WM_GetDesktopWindowEx(1),
											"Display 1",
											NULL,
											WM_CF_SHOW);
	...
	_ahFrameWin[1] = FRAMEWIN_Create("Control",
									 &_cbCmdWin,
	...
	_ahButton[0] = BUTTON_CreateAsChild(4,
										20,
										_ButtonSizeX,
										_ButtonSizeY,
										_ahInfoWin[1],
										...
										WM_CF_STAYONTOP |
										WM_CF_MEMDEV);
	_ahButton[1] = BUTTON_CreateAsChild(40,
										20,
										_ButtonSizeX,
										_ButtonSizeY,
										_ahInfoWin[1],
	...
	_ahFrameWin[0] = FRAMEWIN_Create("emWin Demo",
									 NULL,
									 WM_CF_STAYONTOP,
									 xPos,
									 yPos,
	...
	_ahInfoWin[0] = WM_CreateWindowAsChild(0,
										   0,
										   0,
										   0,
										   WM_GetFirstChild(_ahFrameWin[0]),
										   WM_CF_SHOW | WM_CF_STAYONTOP,
										   0,
										   0);
	WM_ExecIdle();
