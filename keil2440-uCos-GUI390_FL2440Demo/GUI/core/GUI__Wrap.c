...
*  not counted
*/
int GUI__WrapGetNumCharsDisp(const char GUI_UNI_PTR *pText,
							 int xSize,
...
*/
int GUI__WrapGetNumCharsToNextLine(const char GUI_UNI_PTR *pText,
								   int xSize,
								   GUI_WRAPMODE WrapMode)
{
	int NumChars;
...
*/
int GUI__WrapGetNumBytesToNextLine(const char GUI_UNI_PTR *pText,
								   int xSize,
								   GUI_WRAPMODE WrapMode)
{
