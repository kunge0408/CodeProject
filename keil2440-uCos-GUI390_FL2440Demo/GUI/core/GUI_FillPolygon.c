...
*/
static int _CheckYInterSect(int y,
							int *px,
							const GUI_POINT *paPoint0,
...
*/
static int _GetPrevPointDiffy(const GUI_POINT *paPoint,
							  int i,
							  const int NumPoints,
							  const int y0)
{
...
*/
void GL_FillPolygon(const GUI_POINT *paPoint,
					int NumPoints,
					int xOff,
					int yOff)
{
