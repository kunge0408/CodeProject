...
#include "GUIDebug.h"
//#include "LCD_0.h"            /* Defines for first display */include "lcdd.h"



extern   void WriteLcdMems( U32 off  , U32  c ) ; 
extern   U32 ReadLcdMems( U32 off) ; 

extern void Lcd_Tft_LTV350QV_F05_Init(void);
extern Lcd_LTV350QV_F05_Init(void);

extern void LCD2440_SetPixel(U32 x,U32 y,U32 c);
extern void LCD2440_GetPixeIndexl(U32 x,U32 y,U32 c);
extern U32 GetPixelVal(U32 x,U32 y);
...
#define LCD_READ_REG(Off)   0      //这个函数可以不用定义 反正我们没有用到 
...
static void XorPixel   (int x, int y) {
  ...
  LCD2440_SetPixel(x,y,LCD_NUM_COLORS-1-Index);
