...
*/
void WIDGET__RotateRect90(WIDGET *pWidget,
						  GUI_RECT *pDest,
...
{
	pWidget->pEffect =&WIDGET_Effect_3D;// _pEffectDefault;
	pWidget->State = State;
	pWidget->Id = Id;
}
...
*/
void WIDGET__SetScrollState(WM_HWIN hWin,
							const WM_SCROLL_STATE *pVState,
							const WM_SCROLL_STATE *pHState)
{
	WM_HWIN hScroll;
	/* vertical scrollbar */
