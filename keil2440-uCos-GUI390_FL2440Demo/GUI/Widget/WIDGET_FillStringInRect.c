...
* Notes
*/
void WIDGET__FillStringInRect(const char GUI_UNI_PTR *pText,
							  const GUI_RECT *pFillRect,
							  const GUI_RECT *pTextRectMax,
							  const GUI_RECT *pTextRectAct)
{
	...
	if (pText)
	{
		if (*pText)
		{
			/* Speed optimization, not required */
